...
public class UserRepositoryImpl implements UserRepository {
    ...
    public Integer create(String firstName, String lastName, String email, String password) throws EtAuthException {
        ...
        try {
            ...
            return key.map(integerIntegerMap -> (Integer) integerIntegerMap.get("USER_ID")).orElse(null);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public User findByEmailAndPassword(String email, String password) throws EtAuthException {
        try {
            User user = jdbcTemplate.queryForObject(SQL_FIND_BY_EMAIL, UtilityFunctions.userRowMapper, email);
    ...
    public User findById(Integer userId) {
        return jdbcTemplate.queryForObject(SQL_FIND_BY_ID, UtilityFunctions.userRowMapper, userId);
