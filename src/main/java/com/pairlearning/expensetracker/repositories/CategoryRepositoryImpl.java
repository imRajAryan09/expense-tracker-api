...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    public List<Category> findAll(Integer userId) throws EtResourceNotFoundException {
        return jdbcTemplate.query(SQL_FIND_ALL, UtilityFunctions.categoryRowMapper, userId);
    }

    @Override
    public Category findById(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
        try {
            return jdbcTemplate.queryForObject(SQL_FIND_BY_ID, UtilityFunctions.categoryRowMapper, userId, categoryId);
        } catch (Exception e) {
    ...
    public Integer create(Integer userId, String title, String description) throws EtBadRequestException {
        try {
            ...
            Optional<Map<String, Object>> key = Optional.ofNullable(keyHolder.getKeys());
            return key.map(integerIntegerMap -> (Integer) integerIntegerMap.get("CATEGORY_ID")).orElse(null);
        } catch (Exception e) {
